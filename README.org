...
*semidiscrete* depends on [[http://eigen.tuxfamily.org/index.php?title=Main_Page][Eigen3]], [[https://www.boost.org/][Boost]], and [[https://www.cgal.org/][CGAL]].
...
#+BEGIN_SRC bash :exports code :results silent :var version="3.3.7" :dir resources
...
sudo make install
#+END_SRC
- Install boost and CGAL from =apt=
...
#+BEGIN_SRC latex :exports results :file resources/transport.png
\begin{equation*}
